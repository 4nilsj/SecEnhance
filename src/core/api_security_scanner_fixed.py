...
class APISecurityScanner:
    ...
    def add_auth_header(self, key: str, value: str):
        ...
        self.session.headers[key] = value
        print(f"âœ… Added auth header: {key}")
    ...
    def set_bearer_token(self, token: str):
        ...
        self.session.headers['Authorization'] = f'Bearer {token}'
        print(f"âœ… Bearer token configured")
    ...
    def set_api_key(self, key: str, value: str, location: str = 'header'):
        ...
        if location == 'header':
            self.session.headers[key] = value
        print(f"âœ… API key configured: {key} in {location}")
    ...
    def set_basic_auth(self, username: str, password: str):
        ...
        self.session.auth = (username, password)
        print(f"âœ… Basic auth configured: {username}")
    ...
    def set_oauth2_token(self, access_token: str):
        ...
        print(f"âœ… OAuth2 token configured")
...
if __name__ == "__main__":
    ...
    print("ðŸ” OWASP API Top 10 Security Scanner with Collection Support")
    print("=" * 60)
    
    # Example 1: Scan from Swagger URL with OWASP reporting
    print("\nðŸ“‹ Example 1: Scanning from Swagger URL with OWASP Top 10")
    ...
    if 'error' not in swagger_results:
        ...
        print(f"âœ… Standard scan completed. Report saved to: {report_file}")
        
        # Generate OWASP API Top 10 report
        owasp_report_file = scanner.generate_owasp_report(swagger_results, 'html')
        print(f"âœ… OWASP API Top 10 report saved to: {owasp_report_file}")
        
        # Display OWASP checklist summary
        owasp_checklist = scanner.generate_owasp_api_top10_checklist(swagger_results)
        print("\nðŸ“Š OWASP API Top 10 Checklist Summary:")
        print("-" * 40)
        
        for vuln_id, vuln_info in owasp_checklist.items():
            status_icon = "ðŸ”´" if vuln_info['status'] == 'Vulnerable' else "ðŸŸ¢" if vuln_info['status'] == 'Secure' else "âšª"
            print(f"{status_icon} {vuln_id}: {vuln_info['status']} ({vuln_info['vulnerabilities_found']} vulns)")
    else:
        print(f"âŒ Swagger scan failed: {swagger_results['error']}")
    
    # Example 2: Upload and scan API collection
    print("\nðŸ“ Example 2: Upload and scan API collection")
    ...
    #     print(f"\nðŸ“‚ Processing: {collection_file}")
    #     results = scanner.upload_and_scan_collection(collection_file, base_url)
    #     
    #     if 'error' not in results:
    #         print(f"âœ… Collection format: {results['collection_format']}")
    #         print(f"âœ… Endpoints found: {results['endpoints_found']}")
    #         print(f"âœ… Reports: {results['reports']['standard_report']}, {results['reports']['owasp_report']}")
    #     else:
    #         print(f"âŒ Collection scan failed: {results['error']}")
    
    # Example 3: Direct collection scanning
    print("\nðŸ”§ Example 3: Direct collection scanning")
    # results = scanner.scan_from_api_collection("my_collection.json", "https://api.example.com")
    # if 'error' not in results:
    #     print(f"âœ… Collection scanned successfully!")
    #     print(f"ðŸ“Š Format: {results['collection_format']}")
    #     print(f"ðŸ“Š Endpoints: {results['endpoints_found']}")
    # else:
    #     print(f"âŒ Collection scan failed: {results['error']}")
    
    # Example 4: JSON file scanning
    print("\nðŸ“‹ Example 4: Scanning from JSON file with OWASP Top 10")
    ...
    #     print(f"âœ… JSON scan completed. Reports saved to: {report_file}, {owasp_report_file}")
    # else:
    #     print(f"âŒ JSON scan failed: {json_results['error']}")
    
    print("\nðŸŽ¯ OWASP API Top 10 Categories Covered:")
    print("=" * 50)
    print("ðŸ”´ API1:2023 - Broken Object Property Level Authorization")
    print("ðŸ”´ API2:2023 - Broken Authentication")
    print("ðŸ”´ API3:2023 - Broken Object Property Level Authorization")
    print("ðŸŸ¡ API4:2023 - Unrestricted Resource Consumption")
    print("ðŸ”´ API5:2023 - Broken Function Level Authorization")
    print("ðŸŸ¡ API6:2023 - Unrestricted Access to Sensitive Business Flows")
    print("ðŸŸ¡ API7:2023 - Server-Side Request Forgery")
    print("ðŸŸ¢ API8:2023 - Security Misconfiguration")
    print("ðŸŸ¢ API9:2023 - Improper Inventory Management")
    print("ðŸŸ¢ API10:2023 - Unsafe Consumption of APIs")
    
    print("\nðŸ“ Supported API Collection Formats:")
    print("=" * 40)
    print("ðŸ“‹ Postman Collections (.json)")
    print("   â€¢ Full request/response data")
    print("   â€¢ Authentication information")
    print("   â€¢ Environment variables")
    print("   â€¢ Headers and body data")
    
    print("\nðŸ“‹ Insomnia Collections (.json)")
    print("   â€¢ Request configurations")
    print("   â€¢ Headers and authentication")
    print("   â€¢ Body data and parameters")
    
    print("\nðŸ“‹ HAR Files (.har)")
    print("   â€¢ HTTP Archive format")
    print("   â€¢ Browser network traffic")
    print("   â€¢ Complete request/response data")
    
    print("\nðŸ“‹ curl Commands (.txt)")
    print("   â€¢ Command-line curl requests")
    print("   â€¢ Headers and data extraction")
    print("   â€¢ URL and method parsing")
    
    print("\nðŸ“‹ Generic JSON (.json)")
    print("   â€¢ Custom API specifications")
    print("   â€¢ Simple endpoint definitions")
    print("   â€¢ Flexible format support")
    
    print("\nðŸš€ API Security Scanner ready for integration with Burp Suite!")
    print("ðŸ“– Features:")
    print("   â€¢ OWASP API Top 10 2023 compliance")
    print("   â€¢ Swagger/OpenAPI specification parsing")
    print("   â€¢ API collection upload and parsing")
    print("   â€¢ Multiple collection format support")
    print("   â€¢ Comprehensive vulnerability testing")
    print("   â€¢ Detailed HTML and JSON reporting")
    print("   â€¢ Security scoring and recommendations")
    print("   â€¢ Burp Suite integration ready")
    
    print("\nðŸ’¡ Usage Examples:")
    print("   â€¢ Upload Postman collection for security testing")
    print("   â€¢ Import HAR files from browser traffic")
    print("   â€¢ Parse curl commands for API testing")
    print("   â€¢ Scan Swagger/OpenAPI specifications")
    print("   â€¢ Generate OWASP-compliant security reports")
